# Generated by Django 5.1.7 on 2025-06-23 18:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transmission', models.CharField(blank=True, choices=[('manual', 'Механическая'), ('automatic', 'Автоматическая'), ('robot', 'Робот'), ('variator', 'Вариатор')], max_length=20, null=True, verbose_name='Коробка передач')),
                ('acceleration', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='Разгон до 100 км/ч (сек)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='images', to='car.equipment', verbose_name='Комплектация')),
            ],
            options={
